...
public class RDFSMinClosure implements Mutator {
    MultiMap<Node, Node> subProperties = MultiMap.createMapList();
    MultiMap<Node, Node> subClasses = MultiMap.createMapList();
    ...
    private void extract(Model closure, Property p, MultiMap<Node, Node> table) {
